return { 'neoclide/coc.nvim', branch = 'release', config = function(config)
  ...
  keyset("n", "<leader>di", ":<C-u>CocDiagnostics<cr>", {silent = true})
  ...
  keyset("x", "<leader>fix", "<Plug>(coc-codeaction)", opts)
  keyset("n", "<leader>fix", "<Plug>(coc-codeaction)", opts)
  ...
  -- keyset("n", "<space>di", ":<C-u>CocList diagnostics<cr>", opts)
  -- -- Manage extensions
